<p>
    ...
    <a href="<?= URL ?>index.php/admin/trashBanner?page=1"><button type="button"
...
<table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        <td>
            ...
            <a onclick="actionChange('Ẩn Tin tức','<?= URL ?>index.php/admin/delStatusBanner/<?= $value['id'] ?>')"
                class="showcursor"> <img class="icon" style="width:50px;"
                    src="<?= URL ?>public/backend/images/status.png" /></a>

            <?php } else { ?>
            <a onclick="actionChange('Hiện Tin Tức','<?= URL ?>index.php/admin/retoreStatusBanner/<?= $value['id'] ?>')"
                class="showcursor"> <img class="icon " style="width:50px;"
                    src="<?= URL ?>public/backend/images/forbidden.png" /></a>
            <?php } ?>
        </td>

        <td><a href="<?= URL ?>index.php/admin/editBanner/<?= $value['id'] ?>"><img class="icon" style="width:50px;"
                    src="<?= URL ?>public/backend/images/edit.png" /></a></td>
        <td><a onclick="actionChange('Chuyển vào trash','<?= URL ?>index.php/admin/delTempBanner/<?= $value['id'] ?>')"><img
