<p>
    <a href="<?= URL ?>index.php/admin/bannerList?page=1"><button type="button"
...
<table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        <td><a onclick="actionChange('Khôi phục','<?= URL ?>index.php/admin/retoreTempBanner/<?= $value['id'] ?>')"><img
                    class="icon" style="width:50px;" src="<?= URL ?>public/backend/images/recover.png" /></a></td>
        <td><a onclick="actionChange('Xóa','<?= URL ?>index.php/admin/deleteBanner/<?= $value['id'] ?>')"><img
