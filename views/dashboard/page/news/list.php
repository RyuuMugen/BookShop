<p>
    ...
    <a href="<?= URL ?>index.php/admin/trashNews?page=1"><button type="button"
...
<table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        <td><img style="width:100px;height:60px;" src="<?= URL ?>public/img/news/<?= $value['avatar'] ?>" alt=""></td>
        ...
        <td><a href="<?= URL ?>index.php/admin/editNews/<?= $value['id'] ?>"><img class="icon" style="width:50px;"
                    src="<?= URL ?>public/backend/images/edit.png" /></a></td>
        <td><a onclick="actionChange('Chuyển vào trash','<?= URL ?>index.php/admin/delTempNews/<?= $value['id'] ?>')"><img
