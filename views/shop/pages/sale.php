            ...
            <?php foreach ($data["sale_products"] as $value) : ?>
                <div class='col-lg-3 col-md-6 col-sm-6 col-6 mt-3'>
                    <div class='card product p-2' style='width:auto'>
                        <a href="<?= URL ?>index.php/home/details/<?= $value["id"] ?>"><img class='proo card-img-top' style='width: 100%; height: 400px;' src='<?= URL ?>public/img/book/<?= $value["image"] ?>' alt='<?= $value["image"] ?>'></a>
                        <div class='card-title product-title text-center h5'>
                            <a href="<?= URL ?>index.php/home/details/<?= $value["id"] ?>" class='proo'><?= $value["product_name"] ?></a>
                        </div>
                        ...
                        <div class='price text-center h6'>
                            <?= number_format($value["price"] - ($value["price"] * ($value["saleprice"] / 100)), 0, '', ',') ?> VNĐ
                        </div>
