...
<div class="row">
    <div class="col-3-1 text-center bg-light">
        ...
        <img class="mt-3" src="<?= URL ?>public/img/avatar/<?= $_SESSION['avatar']?>" alt="" style="width: 200px; border-radius:50%;">
    ...
    <div class="col-9-1" id="form1" style="display: none;">
        <div class="text-center">
            <h1>ĐỔI MẬT KHẨU</h1>
        </div>
    ...
    <div class="col-9-1" id="form3" style="display: none;">
        <div class="text-center">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($user['delivered'] == 1) {
                                ...
                                <a class="btn btn-primary" onclick="actionChange('Hủy đơn hàng, đơn hàng sẽ bị xóa khỏi hệ thống','<?= URL ?>index.php/home/cancelOrder/<?= $user['id'] ?>')" style="color :white">Hủy đơn hàng</a>
